        ...
        <div>
            <section class="droite" style="text-align: center">
                ...
                ************************
                ...
                Client(e) : <?php echo e($nom_complet); ?>
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td style="padding-left: 15px;"><?php echo e(\App\Models\Outil::formatPrixToMonetaire($montant, false, true)); ?></td>
                        </tr>
                    </tbody>
                </table>
            </section>
...
<?php /**PATH /var/www/html/alfalah_caisse_back/resources/views/pdf/ticket-pharmacie.blade.php ENDPATH**/ ?>